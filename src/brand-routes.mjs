...
<link rel="icon" type="image/png" sizes="512x512" href="/brand/mark-dark-20260918.png" media="(prefers-color-scheme: dark)" />
...
export function registerBrandRoutes(app) {
  for (const [path, filename, type] of [
    ...
    ["/brand/mark-light-20260905-transparent.png", "mark-light-20260918.png", "image/png"],
    ["/brand/mark-dark-20260905-transparent.png", "mark-dark-20260918.png", "image/png"],
  ]) {
