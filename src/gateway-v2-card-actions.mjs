...
function renderActions(data){
 ...
 const actions=data.next_actions||[],run=actions.find(a=>a.kind==='execute_quoted_step'),poll=actions.find(a=>a.kind==='poll'),read=data.result||data.context_view?.results?.length?[]:actions.filter(a=>a.kind==='read_result'),cancel=actions.find(a=>a.kind==='cancel');
