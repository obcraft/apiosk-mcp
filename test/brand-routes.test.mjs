...
test('favicon discovery serves the same transparent marks as MCP metadata', async () => {
 ...
 try {
  for(const [route,file,type] of [['/favicon.svg','mark-20260918.svg','image/svg+xml'],['/favicon.png','apiosk-a-20260921.png','image/png'],['/favicon.ico','favicon.ico','image/x-icon'],['/apple-touch-icon.png','apple-touch-icon.png','image/png']]) {
