...
test('v2 exposes three tools while legacy stays unchanged',async()=>{
 ...
 for(const tool of tools){assert.equal(tool._meta.ui.resourceUri,'ui://apiosk/gateway-v2-card-v4.html');assert.equal(tool._meta['openai/outputTemplate'],'ui://apiosk/gateway-v2-card-v4.html')}
